		...
		createAcc.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String insert = "INSERT INTO `users`(`ID`, `FirstName`, `LastName`, `Email`, `PhoneNumber`, `Password`, `Type`) VALUES ('"+ID+"','"+firstName.getText()+"','"+lastName.getText()+"','"+email.getText()+"','"+phoneNumber.getText()+"','"+password.getText()+"','"+accType+"');";
					...
					if(accType == 0) {
						...
						user.setPhoneNumber(phoneNumber.getText()); // Error at PhoneNumber
						...
						JOptionPane.showMessageDialog(frame, el.getMessage());
