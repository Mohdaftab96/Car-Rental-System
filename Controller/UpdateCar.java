		...
		confirm.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
						...
						String update = "UPDATE `cars` SET `Brand`='"+brand.getText()+"',`Model`='"+model.getText()+"',`Color`='"+color.getText()+"',`Year`='"+yearInt+"',`Price`='"+priceDoub+"' WHERE `ID` = '"+id.getSelectedItem().toString()+"';"; 
						
						database.getStatement().execute(update);
						JOptionPane.showMessageDialog(frame, "Car update successfully");
						frame.dispose();
